...
```php
HeyMan::whenSaving(\App\User::class)->...
HeyMan::whenFetching(\App\User::class)->...
HeyMan::whenCreating(\App\User::class)->...
HeyMan::whenUpdating(\App\User::class)->...
HeyMan::whenDeleting(\App\User::class)->...
```
